...
#### Compiled using JAVA 17 with 1.8 as target and Gradle 7.4.2
...
```groovy
plugins {
  id "io.github.gregoranders.project-configuration" version "0.0.6"
}
```
...
buildscript {
  ...
  dependencies {
    classpath "io.github.gregoranders:project-configuration:0.0.6"
  }
}
