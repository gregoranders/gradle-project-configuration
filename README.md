...
Following the principle of *convention over configuration* this Gradle plugin provides default configurations for various aspects of a Gradle JVM project.
